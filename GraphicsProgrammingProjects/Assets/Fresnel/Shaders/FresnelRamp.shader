Shader "Fresnel/FresnelRamp"
{
    ...
    SubShader
    {
		...
		half4 LightingBlinnPhongBRDF(SurfaceOutput s, half3 lightDir, half3 viewDir, half atten)
		{
			...
			half sawToothFresnel = SawtoothWave(_Frequency * remappedFresnel + _ScrollSpeed * _Time.x);
			
			half finalFresnel = Remap(sawToothFresnel, -1, 1, 0, 1);
