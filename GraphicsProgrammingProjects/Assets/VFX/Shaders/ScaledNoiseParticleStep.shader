Shader "VFX/ScaledNoiseParticleStep"
{
	Properties
	{
		...
		SubShader
		{
			...
			Pass
			{
				...
				fixed4 frag(v2f i) : SV_Target
				{
					...
					//Noise Layer UVs
					float2 UVBaseLayer = ((i.uv + float2(i.color.r, i.color.r)) + (_Time.x * float2(_ScrollSpeedU, _ScrollSpeedV) * i.color.g)) * _Scale * i.color.b;
					float2 UVLayer2 = ((i.uv + float2(i.color.r, i.color.r)) + (_Time.x * float2(_ScrollSpeedULayer2, _ScrollSpeedVLayer2) * i.color.g)) * _ScaleMultiplierLayer2 * i.color.b;
					float2 UVLayer3 = ((i.uv + float2(i.color.r, i.color.r)) + (_Time.x * float2(_ScrollSpeedULayer3, _ScrollSpeedVLayer3) * i.color.g)) * _ScaleMultiplierLayer3 * i.color.b;
