    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
				...
				//Texture Reads
				fixed noise = tex2D(_NoiseTex, UVBaseLayer).a;
				fixed noiseLayer2 = tex2D(_NoiseTex, UVLayer2).a;
				fixed noiseLayer3 = tex2D(_NoiseTex, UVLayer3).a;
				...
				//Combine
                fixed4 col;
				col.rgb = (noise * noiseLayer2) * noiseLayer3;
				col.a = 1;
				return col;
            }
            ENDCG
